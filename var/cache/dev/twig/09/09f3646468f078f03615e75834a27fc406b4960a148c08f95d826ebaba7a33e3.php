...
class __TwigTemplate_83f51875b371778a1113df8aa06055f25df446d783299350a150dd5627f907d0 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        ";
        // line 14
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["regForm"]) || array_key_exists("regForm", $context) ? $context["regForm"] : (function () { throw new RuntimeError('Variable "regForm" does not exist.', 14, $this->source); })()), 'form');
        echo "
    </div>
";
    ...
    {
        return array (  109 => 14,  105 => 12,  95 => 8,  92 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "registration/index.html.twig", "C:\\xampp\\htdocs\\menukarte\\templates\\registration\\index.html.twig");
    }
}
