 ...
 */
class getListeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ListeRepository' shared autowired service.
     *
     * @return \App\Repository\ListeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ListeRepository.php';

        return $container->privates['App\\Repository\\ListeRepository'] = new \App\Repository\ListeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
