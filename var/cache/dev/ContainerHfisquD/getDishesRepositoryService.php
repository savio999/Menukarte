 ...
 */
class getDishesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DishesRepository' shared autowired service.
     *
     * @return \App\Repository\DishesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DishesRepository.php';

        return $container->privates['App\\Repository\\DishesRepository'] = new \App\Repository\DishesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
